...
- Разработчик телеграмм бота [Мафия](https://t.me/TrustNoOneGameBot), для игры в чатах и группах. Прод проект (Командный). Стек: FastAPI, React, PostgreSQL
- Nevsky RP - Role Play сервер GTA 5 на Rage MP.
- Веду разработку телеграмм бота для генерации песен через SUNO.
...
✨ **Особенности:**
- 🎥 **Синхронизированный плеер** — фильм идёт у всех одновременно
- 🎙️ **Голосовое общение** в лобби
- 📹 **Видеосвязь** в комнатах
- 🔗 **Генерация ссылок** для приглашения друзей
- 🎨 **React фронтенд** с современным UI

**🛠️ Технологии:** Python, FastAPI, React, WebSockets, Vibix (видеобалансер)
...
✨ **Особенности:**
- 🃏 **Ролевая логика** (мирные, мафия, доктор, комиссар)
- ⚔️ **Система боевого пропуска**
- 👥 **Многопользовательская игра**
- 💾 **Сохранение состояния** игр в БД

**🛠️ Технологии:** Python, FastAPI, React, PostgreSQL
...
**🛠️ Технологии:** Python, requests, Steam API
