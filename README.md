...
### 🎯 Текущие цели
- Завершить курс в Яндекс Практикуме (Последний проектеый месяц)

## 🚧 Текущие проекты
- Разработчик телеграмм бота [Мафия](https://t.me/TrustNoOneGameBot), для игры в чатах и группах. Прод проект (Командный).
- Веду разработку телеграмм бота для генерации музыки через SUNO.
